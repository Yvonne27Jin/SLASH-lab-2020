...
#Filter out non-completed surveys 

df_0 <- df_labelled %>% filter(Finished == "False") 
#write.csv(df_0_na,"NA.csv")
...
parti <- df_0 %>% filter(Eli1 == "Yes" & Eli2 == "Yes")
# 647 -> 647
...
write.csv(COVID_cleaned, "COVID_cleaned_0127.csv",row.names = F, fileEncoding = "UTF-8")
